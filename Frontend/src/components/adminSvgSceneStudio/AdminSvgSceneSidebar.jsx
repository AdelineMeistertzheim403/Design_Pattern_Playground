    ...
    <aside className="flex flex-col gap-6">
      <section className="rounded-[30px] border border-black/10 bg-white/85 p-5 shadow-[0_18px_45px_rgba(47,37,22,0.08)]">
        ...
        <label className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
          <span className="font-semibold text-stone-900">Scène à éditer</span>
        ...
        <label className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
          <span className="font-semibold text-stone-900">Nom de la scène</span>
        ...
        >
          Réimporter la scène du pattern
        </button>
        <label className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <label className="flex flex-col gap-2 text-sm text-stone-700">
            <span className="font-semibold text-stone-900">Largeur scène</span>
          ...
          <label className="flex flex-col gap-2 text-sm text-stone-700">
            <span className="font-semibold text-stone-900">Hauteur scène</span>
        ...
        <label className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
          <span className="font-semibold text-stone-900">Étapes</span>
          <textarea
      ...
      <section className="rounded-[30px] border border-black/10 bg-white/85 p-5 shadow-[0_18px_45px_rgba(47,37,22,0.08)]">
        ...
        <label className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
          ...
          <input className="rounded-2xl border border-black/10 bg-white px-3 py-3 text-sm text-stone-900 outline-none" placeholder="Nouvelle scène" value={newSceneName} onChange={(event) => onNewSceneNameChange(event.target.value)} />
        </label>
