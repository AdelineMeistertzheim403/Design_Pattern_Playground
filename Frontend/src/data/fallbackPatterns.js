  ...
  builder: {
    fields: [
      ...
      },
      {
        ...
        type: 'SELECT',
        required: true,
        allowedValues: ['CAR', 'CHARACTER', 'HOUSE'],
        defaultValue: 'CAR',
      },
      {
        name: 'silhouette',
        ...
        type: 'SELECT',
        required: true,
        allowedValues: ['COMPACT', 'BALANCED', 'GRAND'],
      ...
      },
      {
        ...
        type: 'SELECT',
        required: true,
        allowedValues: ['ELECTRIC', 'ARCANE', 'SOLAR'],
      ...
      },
      {
        ...
        type: 'SELECT',
        required: true,
        allowedValues: ['DEFENSE', 'MOBILITY', 'SUPPORT'],
      ...
      },
      {
        ...
        type: 'SELECT',
        required: true,
        allowedValues: ['CLASSIC', 'NEON', 'ECO'],
...
function addBuilderStats(baseStats, bonusStats) {
  return {
...
function fillBuilderTemplate(template, buildName) {
  return `${template ?? ''}`.replaceAll('{name}', buildName)
}

function createBuilderStage(product, stageCode, option, buildName, runningStats) {
...
function buildBuilderVisualization(product, stages, readyLabel, useBuilder, buildName, finalStats) {
  const nodes = [
    {
      id: 'client',
      label: 'Client',
